...
public class Support extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Support frame = new Support("test3");
	...
	public Support(String name) {
		...
		Problem_1_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ce = cc.getlatestorderdetails();
				
					textArea.append("\t\t\t                     "+name+" :  I have not received my order\n");
					if (ce.getOrderstatus() == true && ce.getDelivaryStatus() == false) {
						
						textArea.append("Team Alpha  :   Your Order is Out for delivery\n");
					}
					else if (ce.getOrderstatus() == false ) {
						textArea.append("Team Alpha  :   We received your order and will be assigned soon.\n");
					}
					else {
						textArea.append("Team Alpha  :   Your Order is delivered\n");
					}
		...
		Problem_2_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				cm.setComplaint(Problem_2_btn.getText());
				cm.setCustomername(name);
				sdb.setComplaintCust(cm);
				textArea.append("\t\t                    "+name+" :  I have packaging/spillage issue with my order\n");
				textArea.append("Team Alpha  :   Sorry for the inconvinience\n");
				textArea.append("Team Alpha  :   Your Complaint is forworded to the Admin's desk\n");
			}
		});
		...
		Problem_3_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Problem_12_btn.setVisible(false);
				Complaint_model cm = new Complaint_model();
				cm.setComplaint(Problem_3_btn.getText());
				cm.setCustomername(name);
				sdb.setComplaintCust(cm);
		...
		Problem_5_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Problem_12_btn.setVisible(false);
				Complaint_model cm = new Complaint_model();
				cm.setComplaint(Problem_5_btn.getText());
				cm.setCustomername(name);
				sdb.setComplaintCust(cm);
		...
		Problem_6_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textArea.append("Team Alpha  :   Please Contact the support team.\n");
